...
/// @title Token contract - Implements Standard Token Interface with ASC features.
...
contract AscToken is StandardToken {
    ...
    /// @param _founder Address of the founder of ASC.
    function AscToken(address _founder)
    {
        totalSupply = 0;
        founder = _founder;
    }
